...
export function Win95DraggableNote() {
  return (
    ...
    >
      <div className="win95-titlebar bg-gradient-to-r from-[#2d39ff] to-[#7aa6ff] flex items-center justify-between px-2 py-1">
      ...
      <div className="win95-sunken m-1 bg-white p-2 leading-snug text-w95-ink">
        <p className="font-bold">Super vibe</p>
        <p className="mt-1 text-w95-muted">Click Admin to update projects and skills quickly.</p>
      </div>
    </motion.div>
  );
}
